import {
  Router
} from "./chunk-4YW3I53R.js";
import "./chunk-2XONNG3A.js";
import {
  HttpClient,
  HttpClientModule,
  HttpErrorResponse,
  ...
  HttpParams,
  HttpResponse
} from "./chunk-ANHE3FZ4.js";
import {
  CommonModule,
  DOCUMENT,
  isPlatformBrowser
} from "./chunk-HFMC54CC.js";
import {
  BehaviorSubject,
  Inject,
  Injectable,
...
_LoggerService.ɵfac = function LoggerService_Factory(t) {
  return new (t || _LoggerService)(ɵɵinject(AbstractLoggerService));
};
...
_BrowserStorageService.ɵfac = function BrowserStorageService_Factory(t) {
  return new (t || _BrowserStorageService)(ɵɵinject(LoggerService), ɵɵinject(AbstractSecurityStorage));
};
...
_AutoLoginService.ɵfac = function AutoLoginService_Factory(t) {
  return new (t || _AutoLoginService)(ɵɵinject(StoragePersistenceService), ɵɵinject(Router));
};
...
_IFrameService.ɵfac = function IFrameService_Factory(t) {
  return new (t || _IFrameService)(ɵɵinject(DOCUMENT), ɵɵinject(LoggerService));
};
...
_CheckSessionService.ɵfac = function CheckSessionService_Factory(t) {
  return new (t || _CheckSessionService)(ɵɵinject(StoragePersistenceService), ɵɵinject(LoggerService), ɵɵinject(IFrameService), ɵɵinject(PublicEventsService), ɵɵinject(NgZone), ɵɵinject(DOCUMENT));
};
...
_CurrentUrlService.ɵfac = function CurrentUrlService_Factory(t) {
  return new (t || _CurrentUrlService)(ɵɵinject(DOCUMENT));
};
...
_CryptoService.ɵfac = function CryptoService_Factory(t) {
  return new (t || _CryptoService)(ɵɵinject(DOCUMENT));
};
...
_RandomService.ɵfac = function RandomService_Factory(t) {
  return new (t || _RandomService)(ɵɵinject(CryptoService), ɵɵinject(LoggerService));
};
...
_FlowsDataService.ɵfac = function FlowsDataService_Factory(t) {
  return new (t || _FlowsDataService)(ɵɵinject(StoragePersistenceService), ɵɵinject(RandomService), ɵɵinject(LoggerService));
};
...
_JwtWindowCryptoService.ɵfac = function JwtWindowCryptoService_Factory(t) {
  return new (t || _JwtWindowCryptoService)(ɵɵinject(CryptoService));
};
...
_UrlService.ɵfac = function UrlService_Factory(t) {
  return new (t || _UrlService)(ɵɵinject(LoggerService), ɵɵinject(FlowsDataService), ɵɵinject(FlowHelper), ɵɵinject(StoragePersistenceService), ɵɵinject(JwtWindowCryptoService));
};
...
_TokenHelperService.ɵfac = function TokenHelperService_Factory(t) {
  return new (t || _TokenHelperService)(ɵɵinject(LoggerService), ɵɵinject(DOCUMENT));
};
...
_JwkWindowCryptoService.ɵfac = function JwkWindowCryptoService_Factory(t) {
  return new (t || _JwkWindowCryptoService)(ɵɵinject(CryptoService));
};
...
_TokenValidationService.ɵfac = function TokenValidationService_Factory(t) {
  return new (t || _TokenValidationService)(ɵɵinject(TokenHelperService), ɵɵinject(LoggerService), ɵɵinject(JwkExtractor), ɵɵinject(JwkWindowCryptoService), ɵɵinject(JwtWindowCryptoService));
};
...
_HttpBaseService.ɵfac = function HttpBaseService_Factory(t) {
  return new (t || _HttpBaseService)(ɵɵinject(HttpClient));
};
...
_DataService.ɵfac = function DataService_Factory(t) {
  return new (t || _DataService)(ɵɵinject(HttpBaseService));
};
...
_CodeFlowCallbackHandlerService.ɵfac = function CodeFlowCallbackHandlerService_Factory(t) {
  return new (t || _CodeFlowCallbackHandlerService)(ɵɵinject(UrlService), ɵɵinject(LoggerService), ɵɵinject(TokenValidationService), ɵɵinject(FlowsDataService), ɵɵinject(StoragePersistenceService), ɵɵinject(DataService));
};
...
_AuthStateService.ɵfac = function AuthStateService_Factory(t) {
  return new (t || _AuthStateService)(ɵɵinject(StoragePersistenceService), ɵɵinject(LoggerService), ɵɵinject(PublicEventsService), ɵɵinject(TokenValidationService));
};
...
_UserService.ɵfac = function UserService_Factory(t) {
  return new (t || _UserService)(ɵɵinject(DataService), ɵɵinject(StoragePersistenceService), ɵɵinject(PublicEventsService), ɵɵinject(LoggerService), ɵɵinject(TokenHelperService), ɵɵinject(FlowHelper));
};
...
_ResetAuthDataService.ɵfac = function ResetAuthDataService_Factory(t) {
  return new (t || _ResetAuthDataService)(ɵɵinject(AuthStateService), ɵɵinject(FlowsDataService), ɵɵinject(UserService), ɵɵinject(LoggerService));
};
...
_ImplicitFlowCallbackHandlerService.ɵfac = function ImplicitFlowCallbackHandlerService_Factory(t) {
  return new (t || _ImplicitFlowCallbackHandlerService)(ɵɵinject(ResetAuthDataService), ɵɵinject(LoggerService), ɵɵinject(FlowsDataService), ɵɵinject(DOCUMENT));
};
...
_SigninKeyDataService.ɵfac = function SigninKeyDataService_Factory(t) {
  return new (t || _SigninKeyDataService)(ɵɵinject(StoragePersistenceService), ɵɵinject(LoggerService), ɵɵinject(DataService));
};
...
_HistoryJwtKeysCallbackHandlerService.ɵfac = function HistoryJwtKeysCallbackHandlerService_Factory(t) {
  return new (t || _HistoryJwtKeysCallbackHandlerService)(ɵɵinject(LoggerService), ɵɵinject(AuthStateService), ɵɵinject(FlowsDataService), ɵɵinject(SigninKeyDataService), ɵɵinject(StoragePersistenceService), ɵɵinject(ResetAuthDataService), ɵɵinject(DOCUMENT));
};
...
_UserCallbackHandlerService.ɵfac = function UserCallbackHandlerService_Factory(t) {
  return new (t || _UserCallbackHandlerService)(ɵɵinject(LoggerService), ɵɵinject(AuthStateService), ɵɵinject(FlowsDataService), ɵɵinject(UserService), ɵɵinject(ResetAuthDataService));
};
...
_StateValidationService.ɵfac = function StateValidationService_Factory(t) {
  return new (t || _StateValidationService)(ɵɵinject(StoragePersistenceService), ɵɵinject(TokenValidationService), ɵɵinject(TokenHelperService), ɵɵinject(LoggerService), ɵɵinject(EqualityService), ɵɵinject(FlowHelper));
};
...
_StateValidationCallbackHandlerService.ɵfac = function StateValidationCallbackHandlerService_Factory(t) {
  return new (t || _StateValidationCallbackHandlerService)(ɵɵinject(LoggerService), ɵɵinject(StateValidationService), ɵɵinject(AuthStateService), ɵɵinject(ResetAuthDataService), ɵɵinject(DOCUMENT));
};
...
_RefreshSessionCallbackHandlerService.ɵfac = function RefreshSessionCallbackHandlerService_Factory(t) {
  return new (t || _RefreshSessionCallbackHandlerService)(ɵɵinject(LoggerService), ɵɵinject(AuthStateService), ɵɵinject(FlowsDataService));
};
...
_RefreshTokenCallbackHandlerService.ɵfac = function RefreshTokenCallbackHandlerService_Factory(t) {
  return new (t || _RefreshTokenCallbackHandlerService)(ɵɵinject(UrlService), ɵɵinject(LoggerService), ɵɵinject(DataService), ɵɵinject(StoragePersistenceService));
};
...
_IntervalService.ɵfac = function IntervalService_Factory(t) {
  return new (t || _IntervalService)(ɵɵinject(NgZone));
};
...
_ImplicitFlowCallbackService.ɵfac = function ImplicitFlowCallbackService_Factory(t) {
  return new (t || _ImplicitFlowCallbackService)(ɵɵinject(FlowsService), ɵɵinject(Router), ɵɵinject(FlowsDataService), ɵɵinject(IntervalService));
};
...
_SilentRenewService.ɵfac = function SilentRenewService_Factory(t) {
  return new (t || _SilentRenewService)(ɵɵinject(IFrameService), ɵɵinject(FlowsService), ɵɵinject(ResetAuthDataService), ɵɵinject(FlowsDataService), ɵɵinject(AuthStateService), ɵɵinject(LoggerService), ɵɵinject(FlowHelper), ɵɵinject(ImplicitFlowCallbackService), ɵɵinject(IntervalService));
};
...
_CodeFlowCallbackService.ɵfac = function CodeFlowCallbackService_Factory(t) {
  return new (t || _CodeFlowCallbackService)(ɵɵinject(FlowsService), ɵɵinject(FlowsDataService), ɵɵinject(IntervalService), ɵɵinject(Router));
};
...
_CallbackService.ɵfac = function CallbackService_Factory(t) {
  return new (t || _CallbackService)(ɵɵinject(UrlService), ɵɵinject(FlowHelper), ɵɵinject(ImplicitFlowCallbackService), ɵɵinject(CodeFlowCallbackService));
};
...
_AuthWellKnownDataService.ɵfac = function AuthWellKnownDataService_Factory(t) {
  return new (t || _AuthWellKnownDataService)(ɵɵinject(DataService), ɵɵinject(LoggerService));
};
...
_AuthWellKnownService.ɵfac = function AuthWellKnownService_Factory(t) {
  return new (t || _AuthWellKnownService)(ɵɵinject(AuthWellKnownDataService), ɵɵinject(PublicEventsService), ɵɵinject(StoragePersistenceService));
};
...
_RefreshSessionIframeService.ɵfac = function RefreshSessionIframeService_Factory(t) {
  return new (t || _RefreshSessionIframeService)(ɵɵinject(DOCUMENT), ɵɵinject(LoggerService), ɵɵinject(UrlService), ɵɵinject(SilentRenewService), ɵɵinject(RendererFactory2));
};
...
_RefreshSessionRefreshTokenService.ɵfac = function RefreshSessionRefreshTokenService_Factory(t) {
  return new (t || _RefreshSessionRefreshTokenService)(ɵɵinject(LoggerService), ɵɵinject(ResetAuthDataService), ɵɵinject(FlowsService), ɵɵinject(IntervalService));
};
...
_RefreshSessionService.ɵfac = function RefreshSessionService_Factory(t) {
  return new (t || _RefreshSessionService)(ɵɵinject(FlowHelper), ɵɵinject(FlowsDataService), ɵɵinject(LoggerService), ɵɵinject(SilentRenewService), ɵɵinject(AuthStateService), ɵɵinject(AuthWellKnownService), ɵɵinject(RefreshSessionIframeService), ɵɵinject(StoragePersistenceService), ɵɵinject(RefreshSessionRefreshTokenService), ɵɵinject(UserService));
};
...
_ConfigValidationService.ɵfac = function ConfigValidationService_Factory(t) {
  return new (t || _ConfigValidationService)(ɵɵinject(LoggerService));
};
...
_PlatformProvider.ɵfac = function PlatformProvider_Factory(t) {
  return new (t || _PlatformProvider)(ɵɵinject(PLATFORM_ID));
};
...
_ConfigurationService.ɵfac = function ConfigurationService_Factory(t) {
  return new (t || _ConfigurationService)(ɵɵinject(LoggerService), ɵɵinject(PublicEventsService), ɵɵinject(StoragePersistenceService), ɵɵinject(ConfigValidationService), ɵɵinject(PlatformProvider), ɵɵinject(AuthWellKnownService), ɵɵinject(StsConfigLoader));
};
...
_PopUpService.ɵfac = function PopUpService_Factory(t) {
  return new (t || _PopUpService)(ɵɵinject(DOCUMENT), ɵɵinject(LoggerService), ɵɵinject(StoragePersistenceService));
};
...
_CheckAuthService.ɵfac = function CheckAuthService_Factory(t) {
  return new (t || _CheckAuthService)(ɵɵinject(CheckSessionService), ɵɵinject(CurrentUrlService), ɵɵinject(SilentRenewService), ɵɵinject(UserService), ɵɵinject(LoggerService), ɵɵinject(AuthStateService), ɵɵinject(CallbackService), ɵɵinject(RefreshSessionService), ɵɵinject(PeriodicallyTokenCheckService), ɵɵinject(PopUpService), ɵɵinject(AutoLoginService), ɵɵinject(StoragePersistenceService), ɵɵinject(PublicEventsService));
};
...
_ResponseTypeValidationService.ɵfac = function ResponseTypeValidationService_Factory(t) {
  return new (t || _ResponseTypeValidationService)(ɵɵinject(LoggerService), ɵɵinject(FlowHelper));
};
...
_RedirectService.ɵfac = function RedirectService_Factory(t) {
  return new (t || _RedirectService)(ɵɵinject(DOCUMENT));
};
...
_ParService.ɵfac = function ParService_Factory(t) {
  return new (t || _ParService)(ɵɵinject(LoggerService), ɵɵinject(UrlService), ɵɵinject(DataService), ɵɵinject(StoragePersistenceService));
};
...
_ParLoginService.ɵfac = function ParLoginService_Factory(t) {
  return new (t || _ParLoginService)(ɵɵinject(LoggerService), ɵɵinject(ResponseTypeValidationService), ɵɵinject(UrlService), ɵɵinject(RedirectService), ɵɵinject(AuthWellKnownService), ɵɵinject(PopUpService), ɵɵinject(CheckAuthService), ɵɵinject(ParService));
};
...
_PopUpLoginService.ɵfac = function PopUpLoginService_Factory(t) {
  return new (t || _PopUpLoginService)(ɵɵinject(LoggerService), ɵɵinject(ResponseTypeValidationService), ɵɵinject(UrlService), ɵɵinject(AuthWellKnownService), ɵɵinject(PopUpService), ɵɵinject(CheckAuthService));
};
...
_StandardLoginService.ɵfac = function StandardLoginService_Factory(t) {
  return new (t || _StandardLoginService)(ɵɵinject(LoggerService), ɵɵinject(ResponseTypeValidationService), ɵɵinject(UrlService), ɵɵinject(RedirectService), ɵɵinject(AuthWellKnownService), ɵɵinject(FlowsDataService));
};
...
_LoginService.ɵfac = function LoginService_Factory(t) {
  return new (t || _LoginService)(ɵɵinject(ParLoginService), ɵɵinject(PopUpLoginService), ɵɵinject(StandardLoginService), ɵɵinject(StoragePersistenceService), ɵɵinject(PopUpService));
};
...
_AutoLoginAllRoutesGuard.ɵfac = function AutoLoginAllRoutesGuard_Factory(t) {
  return new (t || _AutoLoginAllRoutesGuard)(ɵɵinject(AutoLoginService), ɵɵinject(CheckAuthService), ɵɵinject(LoginService), ɵɵinject(ConfigurationService), ɵɵinject(Router));
};
...
_AutoLoginPartialRoutesGuard.ɵfac = function AutoLoginPartialRoutesGuard_Factory(t) {
  return new (t || _AutoLoginPartialRoutesGuard)(ɵɵinject(AutoLoginService), ɵɵinject(AuthStateService), ɵɵinject(LoginService), ɵɵinject(ConfigurationService), ɵɵinject(Router));
};
...
_AuthInterceptor.ɵfac = function AuthInterceptor_Factory(t) {
  return new (t || _AuthInterceptor)(ɵɵinject(AuthStateService), ɵɵinject(ConfigurationService), ɵɵinject(LoggerService), ɵɵinject(ClosestMatchingRouteService));
};
...
_LogoffRevocationService.ɵfac = function LogoffRevocationService_Factory(t) {
  return new (t || _LogoffRevocationService)(ɵɵinject(DataService), ɵɵinject(StoragePersistenceService), ɵɵinject(LoggerService), ɵɵinject(UrlService), ɵɵinject(CheckSessionService), ɵɵinject(ResetAuthDataService), ɵɵinject(RedirectService));
};
